...
$empID = $_POST["empID_Update"];

echo "Todo ID: " . $todoID. "<br>" ;
echo "Todo Start Time: " . $startTime. "<br>" ;
echo "Todo End Time: " . $endTime. "<br>" ;
echo "Todo Content: " . $todoContent. "<br>" ;
echo "Emp ID Update: " . $empID . "<br>" ;

$sql= "UPDATE todo SET todo.startTime=?, todo.endTime=?, todo.todoContent=?, todo.empID=? WHERE todo.todoID= ?";

if($stmt = mysqli_prepare($link, $sql)){
    // Bind variables to the prepared statement as parameters
    mysqli_stmt_bind_param($stmt, "sssii", $param1,$param2,$param3,$param4,$param5);
