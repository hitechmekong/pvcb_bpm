      ...
      <nav class="mt-2">
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
          ...
          for ($i=0; $i<$NoOfFunction; $i++) {
              ...
              else if ($function[$i] == "DashboardBranch") {
                  
              }
              else if ($function[$i] == "DashboardEmp") {
              ...
              else if ($function[$i] == "WorkMange") {
                  
              }
              else if ($function[$i] == "KPIbranchManage") {
                  
              }
              else if ($function[$i] == "KPIempManage") {
                  
              }
              else if ($function[$i] == "BabDebtManage") {
          ...
          <li class="nav-item has-treeview">
            ...
            <ul class="nav nav-treeview">
              <li class="nav-item">
                <a href="wizard/loans.html" class="nav-link">
                  <i class="far fa-circle nav-icon"></i>
                  <p>Tín dụng</p>
                </a>
              </li>
              ...
              <div class="card-body">
                <ul class="todo-list" data-widget="todo-list">
                  <li>
                    ...
                    <!-- todo text -->
                    <span class="text">Điện thoại nhắc nợ KH Nguyễn Văn A</span>
                    <!-- Emphasis label -->
                    <small class="badge badge-danger"><i class="fas fa-user-tie"></i> Nguyễn Thanh Di</small>
                  ...
                  <li>
                    ...
                    <span class="text">Trình hồ sơ KH Nguyễn Thu Trang - 1 tỉ</span>
                    <small class="badge badge-info"><i class="fas fa-user-tie"></i> Huỳnh Minh Thành</small>
                    <div class="tools">
                      <i class="fas fa-edit"></i>
                      <i class="fas fa-trash-o"></i>
                    </div>
                  ...
                  <li>
                    ...
                    <span class="text">Nhắc nợ KH Phạm Hoàng Tiến</span>
                    <small class="badge badge-success"><i class="fas fa-user-tie"></i> Huỳnh Văn Điền</small>
                    <div class="tools">
                      <i class="fas fa-edit"></i>
                      <i class="fas fa-trash-o"></i>
                    </div>
                  ...
                  <li>
                    ...
                    <span class="text">Trình Hồ sơ KH Trương Việt Dũng - 2,5 tỉ</span>
                    <small class="badge badge-success"><i class="fas fa-user-tie"></i> Lê Khánh Hưng</small>
                    <div class="tools">
                      <i class="fas fa-edit"></i>
                      <i class="fas fa-trash-o"></i>
                    </div>
                  ...
                  <li>
                    ...
                    <span class="text">Gặp KH Nguyễn Thị Thu Ba - 50tr Bảo hiểm</span>
                    <small class="badge badge-primary"><i class="fas fa-user-tie"></i> Phan Thị Ngọc Hiểu</small>
                    <div class="tools">
                      <i class="fas fa-edit"></i>
                      <i class="fas fa-trash-o"></i>
                    </div>
                  ...
                  <li>
                    ...
                    <span class="text">Tặng quà sinh nhật cô Thu - KH tiết kiệm 5 tỉ</span>
                    <small class="badge badge-secondary"><i class="fas fa-user-tie"></i> Nguyễn Thị Quỳnh Như</small>
                    <div class="tools">
                      <i class="fas fa-edit"></i>
                      <i class="fas fa-trash-o"></i>
                    </div>
